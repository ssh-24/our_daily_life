          ...
          <div className="navigation">
              ...
              <div className="btn-list">
                  <div className="btn-item">
                      { props.status === 'home' ?
                        <HomeBtnOn onClick={goMain}/>
                       : 
                        <HomeBtn onClick={goMain}/>
                      }
                  </div>
                  <div className="btn-item">
                      { visible ?
                        <AddBtnOn onClick={uploadClicked}/>
                      : 
                        <AddBtn onClick={uploadClicked}/>
                      }
                  </div>
                  ...
                  <div className="btn-item">
                      { props.status === 'profile' ?
                        <ProfileBtnOn onClick={profileClicked}/>
                      :
                        <ProfileBtn onClick={profileClicked}/>
                      }
                  </div>
